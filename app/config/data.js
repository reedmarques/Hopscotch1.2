// import beer from '../../images/orderCategoryImages';
import Icon from 'react-native-vector-icons/FontAwesome';


export const LeftMenuData1 = [
  {
    title:"Order",
...
export const drinkTypes = [
  {
    "name":"Brews",
    "themeColor":"#f9bf3b",
    "icon":require('../../images/orderCategoryImages/beer.png'),
  },
  {
    "name":"Shooters",
    "themeColor":"#1bbc9b",
    "icon":require('../../images/orderCategoryImages/tequila.png'),
  },
  {
    "name":"Mixed",
    "themeColor":"#f64747",
    "icon":require('../../images/orderCategoryImages/cocktail.png'),
  },
  {
    "name":"Specials",
    "themeColor":"#4b77be",
    "icon":require('../../images/orderCategoryImages/champagne.png'),
  },
  {
    "name":"Favorites",
    "themeColor":"#cf000f",
    "icon":require('../../images/orderCategoryImages/like.png'),
  }
]

export const bars = [
  {
    name:"Stackd Burgers and Beer",
    street:"12 Metro Street",
    city:"Pittsburgh",
    state:"PA",
    zipcode:"15213",
  },
  ...
  {
    name:"Reed's Bar",
    street:"56 Metro Street",
    city:"Pittsburgh",
    state:"PA",
    zipcode:"15213",
  },
  {
    name:"Jaxs Dog Bar and Grille",
    street:"78 Metro Street",
    city:"Pittsburgh",
    state:"PA",
    zipcode:"15213",
  },
    ...
    "drinkList": [
      {
        "name":"Coors Light",
        "price":4.5,
        "description": "A nice refreshing Coors Light",
      },
      {
        "name":"Bud Light",
        "price":4.5,
        "description": "A nice refreshing Bud Light",
      },
      {
        "name":"Heinekin",
        "price":4,
        "description": "A nice refreshing Heinekin",
      },
      {
        "name":"Natural Light",
        "price":4.5,
        "description": "A nice refreshing Natural Light",
      },
    ],
  },
  {
